...
public abstract class VectorArray2D<V extends Vector<V, S>, S extends Scalar<S>> extends Array2D<V> implements VectorArray<V,S>
{
    ...
    /**
     * Encapsulates the instance of VectorArray into a new VectorArray2D, by
     * creating a Wrapper if necessary. If the original array is already an
     * instance of UInt8Array2D, it is returned.
     * 
     * @param array
     *            the original array
     * @param <V>
   ...
   /**
	...
	public abstract ScalarArray2D<S> channel(int channel);

    /**
     * Iterates over the channels
     * @return  the channels
     */
    public abstract Iterable<? extends ScalarArray2D<S>> channels();
    ...
    private static class Wrapper<V extends Vector<V,S>, S extends Scalar<S>> extends VectorArray2D<V,S> implements Array.View<V>
    {
        ...
        @Override
        public java.util.Iterator<ScalarArray2D<S>> channelIterator()
        {
            return new ChannelIterator();
        }
        ...
        private class ChannelIterator implements java.util.Iterator<ScalarArray2D<S>> 
        {
            int channel = -1;
