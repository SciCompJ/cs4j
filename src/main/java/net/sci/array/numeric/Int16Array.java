...
import net.sci.array.numeric.impl.DenseInt16ArrayFactory;
...
public interface Int16Array extends IntArray<Int16>
{
    ...
    public default Iterator iterator()
    {
        return new Iterator()
        {
            PositionIterator iter = PositionIterator.of(Int16Array.this);
     ...
     */
    static class ReshapeView implements Int16Array, Array.View<Int16>
    {
        Int16Array array;
