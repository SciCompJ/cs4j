...
import net.sci.array.numeric.impl.DenseFloat64ArrayFactory;
...
public interface Float64Array extends ScalarArray<Float64>
{
    ...
    public default Iterator iterator()
    {
        return new Iterator()
        {
            PositionIterator iter = PositionIterator.of(Float64Array.this);
     ...
     */
	class ScalarArrayWrapper extends ArrayWrapperStub<Float64> implements Float64Array
	{
		ScalarArray<?> array;
     ...
     */
    static class ReshapeView implements Float64Array, Array.View<Float64>
    {
        Float64Array array;
