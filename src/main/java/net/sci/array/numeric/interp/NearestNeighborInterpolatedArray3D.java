 ...
 * }</pre>
 * 
 * @see NearestNeighborInterpolatedArray2D
 * @see LinearInterpolatedArray3D
 * 
 * @author dlegland
 *
 */
public class NearestNeighborInterpolatedArray3D implements ScalarFunction3D
{
    // ===================================================================
    // class variables
     ...
     *            the array containing values to interpolate.
     */
    public NearestNeighborInterpolatedArray3D(ScalarArray3D<?> array)
    {
        this.array = array;
    }
     ...
     */
    public NearestNeighborInterpolatedArray3D(ScalarArray3D<?> array, double padValue)
    {
        this.array = array;
