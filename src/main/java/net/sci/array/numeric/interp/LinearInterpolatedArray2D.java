 ...
 *
 */
public class LinearInterpolatedArray2D implements ScalarFunction2D
{
    // ===================================================================
    // class variables
     ...
     *            the array containing values to interpolate.
     */
    public LinearInterpolatedArray2D(ScalarArray2D<?> array)
    {
        this.array = array;
    }
     ...
     */
    public LinearInterpolatedArray2D(ScalarArray2D<?> array, double padValue)
    {
        this.array = array;
