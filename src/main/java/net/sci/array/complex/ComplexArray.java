 ...
 *
 */
public interface ComplexArray<C extends Complex> extends Array<C>
{
    // =============================================================
    // New methods
    ...
    @Override
    public ComplexArray.Factory<C> getFactory();
    ...
    public interface Factory<C extends Complex> extends Array.Factory<C>
    {
        /**
    ...
    public interface Iterator<C extends Complex> extends Array.Iterator<C>
    {
//        /**
...
//        }
        ...
        /**
         * Return the modulus of the complex value as default.
         */
