...
public interface AffineTransform3D extends Transform3D
{
    ...
    {
        return new MatrixAffineTransform3D(1, 0, 0, vec.x(), 0, 1, 0, vec.y(), 0, 0, 1, vec.z());
    }
     ...
     * @param sz
     *            the scaling along the Z direction
     * @return a new instance of AffineTransform3D representing a centered
     *         scaling
     */
    public static AffineTransform3D createScaling(Point3D center, double sx, double sy, double sz)
    {
     ...
     *            the vector corresponding to the third axis of the basis.
     * @param vt
     *            the vector corresponding to the translation part of the
     *            resulting transform.
     * @return the resulting transform
     */
    public static AffineTransform3D fromBasis(Vector3D v1, Vector3D v2, Vector3D v3, Vector3D vt)
    {
        return new MatrixAffineTransform3D(
                v1.x(), v2.x(), v3.x(), vt.x(), 
                v1.y(), v2.y(), v3.y(), vt.y(), 
    ...
    /**
     * Computes the 3D Affine transform resulting from the composition of the
