...
public class OctagonStrel extends AbstractSeparableStrel2D
{
	...
	public OctagonStrel(int size, int offset)
	{
		...
		{
			throw new IllegalArgumentException(
					"Offset can not be greater than size");
		}
		this.offset = offset;
			...
			int diagOffset)
	{
		...
		{
			throw new IllegalArgumentException(
					"Requires a positive square size");
		}
		...
		{
			throw new IllegalArgumentException(
					"Requires a positive diagonal size");
		}
		...
		{
			throw new IllegalArgumentException(
					"Requires a non-negative square offset");
		}
		...
		if (diagOffset < 0)
		{
			throw new RuntimeException(
					"Requires a non-negative diagonal offset");
		}
