 ...
 * old value by new value. Local histogram is stored in a tree map, resulting in
 * O(log n) complexity for retrieving value counts.
 * </p>
 * 
 * @see LocalHistogramUInt8
 * @see LocalHistogramDoubleHashMap
