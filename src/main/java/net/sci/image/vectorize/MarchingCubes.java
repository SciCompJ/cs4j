...
public class MarchingCubes extends AlgoStub
{
    ...
    static final int[][] confiFaces = {
            ...
            {4, 9, 8,  7, 10, 11}, // 144
            {2, 0, 10,  10, 0, 8,  3, 6, 1}, // 145
            {8, 4, 9,  10, 11, 7,  5, 2, 0}, // 146
            {8, 5, 1,  5, 1, 9,  5, 2, 1,  10, 11, 7}, // 147
