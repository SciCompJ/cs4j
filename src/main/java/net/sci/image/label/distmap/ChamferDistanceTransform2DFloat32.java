...
public class ChamferDistanceTransform2DFloat32 extends AlgoStub implements ArrayOperator, DistanceTransform2D
{
    ...
    private Float32Array2D initializeResult(IntArray2D<?> labelMap)
    {
        ...
        for (int y = 0; y < sizeY; y++)
        {
            ...
            {
                result.setFloat(x, y, labelMap.getInt(x, y) > 0 ? Float.MAX_VALUE : 0);
            }
        }
	...
	private void backwardIteration(Float32Array2D distMap, IntArray2D<?> labelMap)
	{
    ...
    private void normalizeResult(Float32Array2D distMap, IntArray2D<?> labelMap)
    {
