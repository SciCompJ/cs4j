...
public class ChamferMask3DW6 extends ChamferMask3D
{
	 ...
	 * associated to the six different kind of offsets.  
	 ...
	 * @param f
	 *            the weight associated to permutations of (2, 2, 1)
	 */
	public ChamferMask3DW6(int a, int b, int c, int d, int e, int f)
	{
		this.a = (short) a;
		this.b = (short) b;
		this.c = (short) c;
	 ...
	 * 
	 * @param weights
	 *            the weights associated to the different types of neighbors
	 */
	public ChamferMask3DW6(short[] weights)
	{
		if (weights.length != 6)
		{
			throw new RuntimeException("Number of weights must be 6, not " + weights.length);
		}
		this.a = weights[0];
		this.b = weights[1];
		this.c = weights[2];
