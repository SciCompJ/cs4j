 ...
 * @see net.sci.image.binary.distmap.ChamferDistanceTransform3D
 */
public enum ChamferMasks3D
{
	...
	/**
	 * @return the 3D chamfer mask associated to this enumeration entry 
	 */
	 ...
	 * 
	 * @param label the name of a chamfer mask 
	 * @return the ChamferMask3D enum corresponding to the given name
	 * 
