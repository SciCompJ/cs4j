...
/**
 */
public class CCITT_RLE_Decoder extends FilterInputStream
{
...
//    private final boolean optionUncompressed;
    private final boolean optionByteAligned = true;
...
//    private int lastChangingElement = 0;
     ...
     */
    public CCITT_RLE_Decoder(final InputStream stream, final int columns, final int fillOrder,
                                 final long options) {
...
//        lastChangingElement = 0;
    ...
    private static final class Tree {
        ...
        void fill(final int depth, final int path, final int value) 
        {
            Node current = root;
        ...
        void fill(final int depth, final int path, final Node node) {
            Node current = root;
