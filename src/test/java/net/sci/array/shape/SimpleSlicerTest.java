...
public class SimpleSlicerTest
{
	 ...
	 * 
	 * Test method for {@link net.sci.array.shape.SimpleSlicer#getSlice(net.sci.array.Array, net.sci.array.Array)}.
	 */
	@Test
...
//        Array<String> tmp = array.newInstance(new int[]{5, 4});
	...
	/**
	 * Test method for {@link net.sci.array.shape.SimpleSlicer#process(net.sci.array.Array, net.sci.array.Array)}.
	 */
	@Test
