...
{
    /**
     * Test method for {@link net.sci.array.numeric.Float32Array1D#of(int[])}.
     */
    @Test
    public final void testFromIntArray()
    {
        ...
        Float32Array1D array = Float32Array1D.of(values);
    ...
    {
        Float32Array1D array = Float32Array1D.of(new float[] {0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f});
