...
public class Float32Array3DTest
{
    ...
    /**
     * Test method for {@link net.sci.array.scalar.Float32Array3D#populateValues(net.sci.array.scalar.TriFunction)}.
     */
    @Test
    public final void testPopulate()
    {
        Float32Array3D array = Float32Array3D.create(5, 5, 5);
        array.populateValues((x, y, z) -> Math.hypot(Math.hypot(x - 2, y - 2), z - 2));
