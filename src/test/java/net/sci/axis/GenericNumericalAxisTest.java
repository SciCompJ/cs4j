...
public class GenericNumericalAxisTest
{
    ...
    /**
     * Test method for {@link net.sci.axis.GenericNumericalAxis#valueRange()}.
     */
    @Test
    public final void testPhysicalRange()
    {
        GenericNumericalAxis axis = createDefaultAxis();
        double[] range = axis.valueRange();
    ...
    /**
     * Test method for {@link net.sci.axis.GenericNumericalAxis#getValue(int)}.
     */
    @Test
    public final void testIndexToValue()
    {
        ...
        assertEquals(10.0, axis.getValue(0), 0.01);
        assertEquals(7.0, axis.getValue(2), 0.01);
        assertEquals(3.0, axis.getValue(5), 0.01);
    }
