...
{
	/**
	 * Test method for {@link net.sci.image.label.geoddist.GeodesicDistanceTransform2DFloat32Hybrid#process2d(net.sci.array.binary.BinaryArray2D, net.sci.array.binary.BinaryArray2D)}.
	 */
	@Test
	public final void testProcess_LineSegment()
	{
        ...
        GeodesicDistanceTransform2D op = new GeodesicDistanceTransform2DFloat32Hybrid(mask, false);
    ...
    public final void testProcess_Blobs() throws IOException
    {
        ...
        GeodesicDistanceTransform2D op = new GeodesicDistanceTransform2DFloat32Hybrid(mask, true);
