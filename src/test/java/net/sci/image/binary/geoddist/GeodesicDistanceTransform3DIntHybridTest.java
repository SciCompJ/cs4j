 ...
 *
 */
public class GeodesicDistanceTransform3DIntHybridTest
{
    /**
     * Test method for {@link net.sci.image.binary.geoddist.GeodesicDistanceTransform3DIntHybrid#process3d(net.sci.array.binary.BinaryArray3D, net.sci.array.binary.BinaryArray3D)}.
     */
    @Test
    public void testProcess3d_Cube()
    {
        ...
        GeodesicDistanceTransform3D op = new GeodesicDistanceTransform3DIntHybrid(ChamferMask3D.BORGEFORS, false);
    ...
    public void testProcess3d_HollowCube_Normalized()
    {
        ...
        GeodesicDistanceTransform3D op = new GeodesicDistanceTransform3DIntHybrid(ChamferMask3D.BORGEFORS, true);
        ScalarArray3D<?> res = op.process3d(marker, mask);
