 ...
 * 
 */
public class MaximaImpositionTest
{
    
//    /**
//     * Test method for {@link net.sci.image.morphology.extrema.MaximaImposition#processScalar2d(net.sci.array.numeric.ScalarArray2D, net.sci.array.binary.BinaryArray2D)}.
//     */
//    @Test
...
//
//        ScalarArray2D<?> res = MinimaAndMaxima.imposeMaxima2d(array, minima, Connectivity2D.C4);
...
//    }
    ...
    public final void test_processScalar2d_ramp_uint8()
    {
        ...
        ScalarArray2D<?> res = new MaximaImposition(Connectivity2D.C4).processScalar2d(array, maxima);
    ...
    public final void test_processScalar2d_ramp_ArrayOfUInt8()
    {
        ...
        BinaryArray2D maxima = BinaryArray2D.create(dims[0], dims[1]);
        maxima.setBoolean(2, 2, true);
        maxima.setBoolean(5, 2, true);

        ScalarArray2D<UInt8> scalarArray = ScalarArray2D.wrap(ScalarArray.wrap(array));
        ScalarArray2D<?> res = new MaximaImposition(Connectivity2D.C4).processScalar2d(scalarArray, maxima);
    ...
    @Test
    public final void test_processScalar2d_MaximaWithinMaxRegion_uint8()
    {
        int[] profile = new int[] {50, 255, 255, 255, 255, 255, 50};
        UInt8Array2D array = UInt8Array2D.create(profile.length, 5);
        array.fillInts((x,y) -> profile[x]);
        BinaryArray2D maxima = BinaryArray2D.create(array.size(0), array.size(1));
        maxima.setBoolean(1, 2, true);
        maxima.setBoolean(5, 2, true);
    ...
    /**
     * Test method for {@link net.sci.image.morphology.extrema.MaximaImposition#processScalar3d(net.sci.array.numeric.ScalarArray3D, net.sci.array.binary.BinaryArray3D)}.
     */
    @Test
    public final void test_processScalar3d_ramp3d_uint8()
    {
        ...
        ScalarArray3D<?> res = new MaximaImposition(Connectivity3D.C6).processScalar3d(array, maxima);
    
        // check markers correspond to minimal values
        assertEquals(UInt8.MAX_INT, res.getValue(2, 2, 2), 0.01);
        assertEquals(UInt8.MAX_INT, res.getValue(5, 2, 2), 0.01);
        // keep relative ordering of other values
