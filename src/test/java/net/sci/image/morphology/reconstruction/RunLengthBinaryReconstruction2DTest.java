...
public class RunLengthBinaryReconstruction2DTest
{
    ...
    /**
     * Test method for {@link net.sci.image.morphology.reconstruction.RunLengthBinaryReconstruction2D#reconstructRegion2d(net.sci.array.binary.BinaryArray2D, int, int)}.
     */
    @Test
