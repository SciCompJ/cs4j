...
{
    /**
     * Test method for {@link net.sci.image.regionfeatures.morpho2d.Perimeter#compute(net.sci.image.regionfeatures.RegionFeatures)}.
     */
    @Test
    public final void test_compute()
    {
        ...
        assertEquals(res[0],  2.68, 0.01);
        assertEquals(res[1],  8.37, 0.01);
        assertEquals(res[2],  8.37, 0.01);
        assertEquals(res[3], 14.06, 0.01);
    }
    
    /**
     * Test method for {@link net.sci.image.regionfeatures.morpho2d.Perimeter#updateTable(net.sci.table.Table, net.sci.image.regionfeatures.RegionFeatures)}.
     */
    @Test
    public final void test_updateTable()
    {
        ...
        assertEquals("Perimeter", table.column(0).getName());
    }
    
    /**
     * Test method for {@link net.sci.image.regionfeatures.morpho2d.Perimeter#columnUnitNames(net.sci.image.regionfeatures.RegionFeatures)}.
     */
    @Test
