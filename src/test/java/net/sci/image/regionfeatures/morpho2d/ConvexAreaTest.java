...
{
    /**
     * Test method for {@link net.sci.image.regionfeatures.morpho2d.ConvexArea#compute(net.sci.image.regionfeatures.RegionFeatures)}.
     */
    @Test
    public final void test_compute()
    {
        ...
        ConvexArea feature = new ConvexArea();
    ...
    /**
     * Test method for {@link net.sci.image.regionfeatures.morpho2d.ConvexArea#updateTable(net.sci.table.Table, java.lang.Object)}.
     */
    @Test
    public final void test_updateTable()
    {
        ...
        assertEquals("Convex_Area", table.column(0).getName());
    }
