...
public class MaxFeretDiameterTest
{
    ...
    /**
     * Test method for {@link net.sci.image.regionfeatures.morpho2d.MaxFeretDiameter#compute(net.sci.image.regionfeatures.RegionFeatures)}.
     */
    @Test
    ...
    public final void testUpdateTable()
    {
        ...
        assertEquals("Max_Feret_Diameter", table.column(0).getName());
    }
