...
public class ConvexityTest
{
    ...
    /**
     * Test method for {@link net.sci.image.regionfeatures.morpho2d.Convexity#compute(net.sci.image.regionfeatures.RegionFeatures)}.
     */
    @Test
    public final void testCompute()
    {
        ...
        double[] res = new Convexity().compute(data); 
